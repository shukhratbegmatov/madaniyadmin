      ...
      <div class="mains_card_child">
        <div class="card">
          ...
          <table class="table table-flush" id="datatable">
            ...
            <tbody v-if=" $store.state.news">

            <tr v-for="(item,index) in  $store.state.news.results" :key="index">
              ...
              <td>
                <router-link :to="'/news/edit?id='+item.id" class="btn">
...
export default {
  ...
  methods: {
    ...
    deletes(item) {
      ...
      if (isBoss == true) {
        this.$http.delete('/api/news/' + item + '/',
            {
              headers: {
