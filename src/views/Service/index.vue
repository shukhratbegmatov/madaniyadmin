      ...
      <div class="row">
        ...
        <div class="col">
          <div class="buttons_create">
            <div>
              <h3 class="font-weight-bold mb-3">Услуги</h3>
            </div>
          </div>
    <div class="main_card">
      <div class="mains_card_child">
        <div class="card">
          ...
          <table class="table table-flush" id="datatable">
            ...
            <tbody v-if=" $store.state.services">

            <tr v-for="(item,index) in  $store.state.services.results" :key="index">
              ...
              <td>
                <router-link :to="'/services/edit?id='+item.id" class="btn">
...
export default {
  ...
  methods: {
    ...
    deletes(item) {
      ...
      if (isBoss == true) {
        this.$http.delete('/api/service/' + item + '/',
            {
              headers: {
