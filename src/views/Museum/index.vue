      ...
      <div class="mains_card_child">
        <div class="card">
          ...
          <table class="table table-flush" id="datatable">
            ...
            <tbody v-if=" $store.state.museum">

            <tr v-for="(item,index) in  $store.state.museum.results" :key="index">
              ...
              <td>
                <router-link :to="'/museum/edit?id='+item.id" class="btn">
...
export default {
  ...
  methods: {
    ...
    deletes(item) {
      ...
      if (isBoss == true) {
        this.$http.delete('/api/museum/' + item + '/',
            {
              headers: {
