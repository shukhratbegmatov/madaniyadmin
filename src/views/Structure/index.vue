      ...
      <div class="mains_card_child">
        <div class="card">
          ...
          <table class="table table-flush" id="datatable">
            ...
            <tbody v-if=" $store.state.structure">

            <tr v-for="(item,index) in  $store.state.structure.results" :key="index">
              ...
              <td>
                <router-link :to="'/structure/edit?id='+item.id" class="btn">
...
export default {
  ...
  mounted() {
    this.$store.dispatch('sutructure',{
  ...
  methods: {
    ...
    deletes(item) {
      ...
      if (isBoss == true) {
        this.$http.delete('/api/structure/' + item + '/',
            {
              headers: {
