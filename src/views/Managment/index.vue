      ...
      <div class="row">
        ...
        <div class="col">
          <div class="buttons_create">
            ...
            <router-link to="/managment/create"
      ...
      <div class="mains_card_child">
        <div class="card">
          ...
          <table class="table table-flush" id="datatable">
            ...
            <tbody v-if=" $store.state.managment">
            <tr v-for="(item,index) in  $store.state.managment.results" :key="index">
...
export default {
  ...
  methods: {
    ...
    deletes(item) {
      ...
      if (isBoss == true) {
        this.$http.delete('/api/leaders/' + item + '/',
            {
              headers: {
