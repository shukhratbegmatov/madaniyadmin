                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12  mb-3">
                        <div>
                          ...
                          <input class="form-control" id="first_namee" v-model="obligation" type="text"  required>
                        </div>
                      </div>
                      <div class="col-md-12  mb-3">
                        <div>
                          <label for="first_name">requirement</label>
                          <input class="form-control" id="first_namee" v-model="requirement" type="text"  required>
                        </div>
                      </div>
                      <div class="col-md-12  mb-3">
                        <div>
                          <label for="first_name">work_condition</label>
                          <input class="form-control" id="first_namee" v-model="work_condition" type="text"  required>
                        </div>
                      </div>
...
export default {
  ...
  methods:{
    ...
    post_ru(){
      ...
      form.append("obligation", this.obligation);
