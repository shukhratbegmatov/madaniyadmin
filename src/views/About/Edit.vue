      ...
      <b-card no-body>
        <div class="row">
          ...
          <div class="col-md-3 media">
            ...
            <div class="image_groups"> clear image
...
export default {
  ...
  mounted() {
    this.$http.get('/api/about/'+this.$route.query.id,{
      headers:{
         'Accept-Language':'ru'
      }
      })
