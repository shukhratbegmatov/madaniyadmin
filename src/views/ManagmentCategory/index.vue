      ...
      <div class="row">
        ...
        <div class="col">
          <div class="buttons_create">
            <div>
              <h3 class="font-weight-bold mb-3">Категории управления</h3>
            </div>
            <router-link to="/managment/category/create"
      ...
      <div class="mains_card_child">
        <div class="card">
          ...
          <table class="table table-flush" id="datatable">
            ...
            <tbody v-if=" $store.state.managment_category">
            <tr v-for="(item,index) in  $store.state.managment_category.results" :key="index">
...
export default {
  ...
  mounted() {
    this.$store.dispatch('manGetfunc',{
  ...
  methods: {
    ...
    deletes(item) {
      ...
      if (isBoss == true) {
        this.$http.delete('/api/management/' + item + '/',
            {
              headers: {
