  ...
  <div>
    ...
    <div class=" main_card">
      <div class="mains_card_child">
        <div class="card">
          <div class="p-3">
            <router-link to="/territorial/create"
          ...
          <table class="table table-flush" id="datatable">
            ...
            <tbody v-if=" $store.state.territorial">

            <tr v-for="(item,index) in  $store.state.territorial.results" :key="index">
              ...
              <td>
                <router-link :to="'/territorial/edit?id='+item.id" class="btn">
...
export default {
  ...
  methods: {
    ...
    deletes(item) {
      ...
      if (isBoss == true) {
        this.$http.delete('/api/territorial/' + item + '/',
            {
              headers: {
