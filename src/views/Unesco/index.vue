      ...
      <div class="mains_card_child">
        <div class="card">
          ...
          <table class="table table-flush" id="datatable">
            ...
            <tbody v-if=" $store.state.object">

            <tr v-for="(item,index) in  $store.state.object" :key="index">
              ...
              <td>
                <router-link :to="'/object/edit?id='+item.id" class="btn">
...
export default {
  ...
  methods: {
    ...
    deletes(item) {
      ...
      if (isBoss == true) {
        this.$http.delete('/api/object/' + item + '/',
            {
              headers: {
