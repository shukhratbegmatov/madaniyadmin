      ...
      <div class="row">
        ...
        <div class="col">
          <div class="buttons_create">
            ...
            <router-link to="/organization/create"
      ...
      <div class="mains_card_child">
        <div class="card">
          ...
          <table class="table table-flush" id="datatable">
            ...
            <tbody v-if=" $store.state.organization">

            <tr v-for="(item,index) in  $store.state.organization.results" :key="index">
              ...
              <td>
                <router-link :to="'/organization/edit?id='+item.id" class="btn">
...
export default {
  ...
  methods: {
    ...
    deletes(item) {
      ...
      if (isBoss == true) {
        this.$http.delete('/api/organization/' + item + '/',
            {
              headers: {
